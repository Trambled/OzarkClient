...
public
class CustomFontRenderer extends CustomFont {
    ...
    public
    CustomFontRenderer ( Font font , boolean antiAlias , boolean fractionalMetrics ) {
    ...
    public
    float drawString ( String text , double x , double y , int color , boolean shadow ) {
        x -= 1;
        y -= 2;
        if ( text == null ) {
            return 0.0F;
