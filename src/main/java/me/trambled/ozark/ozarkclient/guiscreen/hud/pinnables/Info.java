...
public class Info extends Pinnable {
	...
	public void render() {
		...
		this.drawHLineG(this.get_x() - padding, this.get_y() - 7, (this.get_x() + padding + this.get_width() + 5) - (this.get_x() - padding), RainbowUtil.getMultiColour().hashCode(), this.getFurtherColour(Ozark.get_setting_manager().get_setting_with_tag("HUD", "offset").get_value(1)).hashCode());
