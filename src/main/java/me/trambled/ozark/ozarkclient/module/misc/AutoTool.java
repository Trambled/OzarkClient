...
class AutoTool extends Module {
    ...
    private
    float blockStrength ( BlockPos pos , ItemStack stack ) {
    ...
    private
    boolean canHarvestBlock ( Block block , BlockPos pos , ItemStack stack ) {
    ...
    private
    float getDigSpeed ( IBlockState state , BlockPos pos , ItemStack stack ) {
    ...
    private
    int getToolInventory ( BlockPos pos ) {
        int index = - 1;
    ...
    private
    int getToolHotbar ( BlockPos pos ) {
        int index = - 1;
