...
class Setting {
    ...
    public
    Setting ( Module master , String name , String tag , int value ) {
        this.master = master;
        this.name = name;
        this.tag = tag;
        this.bind = value;
    ...
    public
    Setting ( Module master , String name , String tag , String value , String id ) {
        this.master = master;
        this.name = name;
        this.tag = tag;
        this.message = value;
    ...
    public
    boolean get_value ( boolean type ) {
        return this.button;
    }
    ...
    public
    String get_value ( String type ) {
        return this.label;
    }

    public
    double get_value ( double type ) {
        return this.slider;
    }
    ...
    public
    String get_preset_message ( String type ) {
