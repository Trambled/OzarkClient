...
class Xray extends Module {
    ...
    public static
    boolean shouldXray ( final Block block ) {
        return Xray.BLOCKS.contains ( block );
    }

    public static
    boolean addBlock ( final String string ) {
    ...
    public static
    boolean delBlock ( final String string ) {
        if ( Block.getBlockFromName ( string ) != null ) {
    ...
    public static
    void processShouldSideBeRendered ( Block block , IBlockState blockState , IBlockAccess blockAccess , BlockPos pos , EnumFacing side , CallbackInfoReturnable < Boolean > callback ) {
        if ( shouldXray ( block ) )
            callback.setReturnValue ( true );
    }

    public static
    void processGetLightValue ( Block block , CallbackInfoReturnable < Integer > callback ) {
        if ( shouldXray ( block ) ) {
