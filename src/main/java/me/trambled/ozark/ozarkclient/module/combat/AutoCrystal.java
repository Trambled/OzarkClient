...
//      }
    ...
    private
    boolean is_predicting_crystal ( SPacketSpawnObject packet ) {
    ...
    private
    boolean is_predicting_block ( EntityEnderCrystal crystal ) {
    ...
    public
    EntityPlayer get_closest_target ( ) {
