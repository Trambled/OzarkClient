...
//gamesense fart
public
class PistonCrystal extends Module {
    ...
    public static
    boolean someoneInCoords ( double x , double z ) {
        int xCheck = (int) x;
        int zCheck = (int) z;
        // Get player's list
    ...
    public static
    EntityPlayer findLookingPlayer ( double rangeMax ) {
        // Get player
    ...
    public static
    boolean basicChecksEntity ( Entity pl ) {
        return pl == mc.player || FriendUtil.isFriend ( pl.getName ( ) ) || pl.isDead;
    }

    // Find closest target
    public static
    EntityPlayer findClosestTarget ( double rangeMax , EntityPlayer aimTarget ) {
        List < EntityPlayer > playerList = mc.world.playerEntities;
    ...
    public static
    void lookAtPacket ( double px , double py , double pz , EntityPlayer me ) {
    ...
    public static
    void setYawAndPitch ( float yaw1 , float pitch1 ) {
        yaw = yaw1;
        pitch = pitch1;
    ...
    public static
    void breakCrystal ( Entity crystal ) {
        try {
    ...
    private
    void breakCrystalPiston ( Entity crystal ) {
        // HitDelay
    ...
    // Place a block
    private
    boolean placeBlock ( BlockPos pos , int step , double offsetX , double offsetZ , double offsetY ) {
        // Get the block
    ...
    public
    void placeBlockThings ( int step ) {
    ...
    public
    BlockPos compactBlockPos ( int step ) {
    ...
    private
    Block get_block ( double x , double y , double z ) {
    ...
    class structureTemp {
        ...
        public
        structureTemp ( double distance , int supportBlock , List < Vec3d > to_place ) {
        ...
        public
        void replaceValues ( double distance , int supportBlock , List < Vec3d > to_place , int direction , float offsetX , float offsetZ , float offsetY ) {
            this.distance = distance;
            this.supportBlock = supportBlock;
            this.to_place = to_place;
