...
class Module implements Listenable {
    ...
    protected
    Setting create ( String name , String tag , int bind ) {
    ...
    protected
    Setting create ( String name , String tag , String value , String id ) {
    ...
    public
    void on_bind ( String tag ) {

    }

    public
    void on_message ( String tag , String message ) {
    ...
    public
    void on_render_model ( final EventRenderEntityModel event ) {
    }
}