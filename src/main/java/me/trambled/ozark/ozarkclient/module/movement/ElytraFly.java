...
class ElytraFly extends Module {
    ...
    public
    void HandleNormalModeElytra ( EventPlayerTravel p_Travel ) {
    ...
    public
    void HandleImmediateModeElytra ( EventPlayerTravel p_Travel ) {
        if ( mc.player.movementInput.jump ) {
    ...
    private
    void HandleControlMode ( EventPlayerTravel p_Event ) {
