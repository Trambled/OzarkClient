...
class AutoGear extends Module {
    ...
    private
    ArrayList < Integer > getInventorySort ( HashMap < Integer, String > copyInventory ,
    ...
    private
    HashMap < Integer, String > getInventoryCopy ( int startPoint ) {
    ...
    // This give a copy of our inventory
    private
    HashMap < Integer, String > getInventoryCopy ( int startPoint , HashMap < Integer, String > inventory ) {
        // Our output
        HashMap < Integer, String > output = new HashMap <> ( );
