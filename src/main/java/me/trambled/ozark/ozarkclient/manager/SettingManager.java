...
class SettingManager {
    ...
    public
    Setting get_setting_with_tag ( Module module , String setting_tag ) {
    ...
    public
    Setting get_setting_with_tag ( String module_tag , String setting_tag ) {
        Setting setting_requested = null;
    ...
    public
    ArrayList < Setting > get_settings_with_module ( Module module ) {
