...
class CrystalUtil {
    ...
    public static
    List < BlockPos > crystalBlocksMomentum ( EntityPlayer entityPlayer , double placeRange , boolean prediction , double predict_factor , boolean antiSurround , boolean endcrystal ) {
    ...
    public static
    List < BlockPos > getNearbyBlocks ( EntityPlayer player , double blockRange , boolean motion , double motion_factor ) {
    ...
    public static
    float calculateDamageBed ( double posX , double posY , double posZ , Entity entity ) {
        if ( entity == mc.player && mc.player.isCreative ( ) ) {
            return 0.0f;
        }
    ...
    public static
    float calculateDamageBed ( BlockPos pos , Entity entity ) {
        return calculateDamageBed ( pos.getX ( ) , pos.getY ( ) , pos.getZ ( ) , entity );
    }

    public static
    boolean raytraceBlock ( BlockPos blockPos , double offset ) {
    ...
    public static
    boolean raytraceQuill ( BlockPos blockPos , double offset ) {
