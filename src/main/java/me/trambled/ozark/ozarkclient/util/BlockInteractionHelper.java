...
class BlockInteractionHelper {
    ...
    public static
    void placeBlockScaffold ( final BlockPos pos , final boolean rotate ) {
    ...
    public static
    void placeBlock ( final BlockPos pos , final boolean rotate ) {
        for (final EnumFacing side : EnumFacing.values ( )) {
            final BlockPos neighbor = pos.offset ( side );
            final EnumFacing side2 = side.getOpposite ( );
            if ( canBeClicked ( neighbor ) ) {
    ...
    public static
    BlockResistance getBlockResistance ( BlockPos block ) {
    ...
    public static
    void placeBlock ( BlockPos pos , boolean rotate , boolean raytrace , boolean packet , boolean swingArm , boolean antiGlitch ) {
    ...
    public static
    boolean isInterceptedByOther ( final BlockPos pos ) {
    ...
    public static
    boolean placeBlockBurrow ( BlockPos pos , EnumHand hand , boolean rotate , boolean packet , boolean isSneaking ) {
    ...
    public static
    void faceVectorPacketInstant ( Vec3d vec , Boolean roundAngles ) {
    ...
    private static
    float[] getNeededRotations2 ( Vec3d vec ) {
