...
public class MainMenu extends GuiScreen {
    ...
    public static void drawMenu(int mouseX, int mouseY) {
        ...
        FontUtil.drawStringWithShadow("Developed by " + TextFormatting.GRAY + "Trambled, x3th0_" + TextFormatting.RESET + " and " + TextFormatting.GRAY + "ProfKambing", GuiCustomMainMenu.getScaledRes().getScaledWidth() - FontUtil.getFontWidth("Developed by " + "Trambled, Ethan, Perry and ProfKambing") - 4, 28, Color.WHITE.getRGB());
