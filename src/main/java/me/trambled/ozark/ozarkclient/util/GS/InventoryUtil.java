package me.trambled.ozark.ozarkclient.util.GS;

import me.trambled.ozark.ozarkclient.module.combat.OffhandGS;
...
public class InventoryUtil {
    ...
    public static int findObsidianSlot(boolean offHandActived, boolean activeBefore) {
        ...
        if (offHandActived && OffhandGS.isActive()) {
            if (!activeBefore) {
                OffhandGS.requestObsidian();
            }
            return 9;
        }
