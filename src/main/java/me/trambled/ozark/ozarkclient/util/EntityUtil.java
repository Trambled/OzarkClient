...
class EntityUtil {
    ...
    public static
    void attackEntity ( final Entity entity ) {
        mc.playerController.attackEntity ( mc.player , entity );
        mc.player.swingArm ( EnumHand.MAIN_HAND );
    }
    ...
    public static
    double[] calculateLookAt ( double px , double py , double pz , Entity me ) {
    ...
    public static
    EntityUtil.FacingDirection GetFacing ( EntityPlayer player ) {
    ...
    //salhack
    public static
    boolean is_entity_trapped ( Entity entity ) {
    ...
    public static
    BlockPos GetEntityPosFloored ( Entity entity ) {
    ...
    public static
    BlockPos getPosition ( Entity pl ) {
