...
public class PistonCrystal extends WurstplusHack
{
    ...
    private void initValues() {
        ...
        if (chatMsg.get_value(true)){
            WurstplusMessageUtil.send_client_message("PistonCrystal turned on");
        }
    ...
    private void printTimeCrystals() {
        ...
        WurstplusMessageUtil.send_client_message("3 crystal, time took: " + (endTime - startTime));
        nCrystal = 0;
    ...
    @EventHandler
    private final Listener<EventNetworkPacketEvent> packetSendListener = new Listener<>(event -> {
