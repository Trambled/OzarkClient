...
//literally just holefill but instead it has buttons
public class AntiHoleFill extends WurstplusHack {
    
    public AntiHoleFill() {
		super(WurstplusCategory.WURSTPLUS_COMBAT);

		this.name        = "AntiHoleFill"; 
		this.tag         = "AntiHoleFill";
		this.description = "puts buttons into holes";
    }
    
    WurstplusSetting hole_toggle = create("Toggle", "AntiHoleFillToggle", true);
    WurstplusSetting hole_rotate = create("Rotate", "AntiHoleFillRotate", true);
    WurstplusSetting hole_range = create("Range", "AntiHoleFillRange", 4, 1, 6);
    WurstplusSetting swing = create("Swing", "AntiHoleFillSwing", "Mainhand", combobox("Mainhand", "Offhand", "Both", "None"));
    ...
    private int find_in_hotbar() {
        for (int i = 0; i < 9; ++i) {
            ...
            if (stack != ItemStack.EMPTY && stack.getItem() instanceof ItemBlock) {
                ...
                if (block instanceof BlockButtonStone) {
                    return i;
                }
