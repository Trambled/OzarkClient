...
public class PastGUIHack extends WurstplusHack {
	...
	WurstplusSetting red = create("Red", "PastGUIR", 16, 0, 255);
	WurstplusSetting green = create("Green", "PastGUIG", 16, 0, 255);
	WurstplusSetting blue = create("Blue", "PastGUIB", 16, 0, 255);
	WurstplusSetting alpha = create("Alpha", "PastGUIA", 255, 0, 255);
	WurstplusSetting rainbow = create("Rainbow", "PastGUIRainbow", true);
	...
	WurstplusSetting snow = create("Snow", "PastGUISnow", true);
