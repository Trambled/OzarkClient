...
import me.travis.wurstplus.wurstplustwo.event.events.EventRenderPutColorMultiplier;
...
public class Xray extends WurstplusHack {
    ...
    WurstplusSetting opacity = create("Opacity", "XrayOpacity", 128, 0, 255);
    WurstplusSetting smooth_reload = create("Smooth Reload", "XraySmoothReload", false);
